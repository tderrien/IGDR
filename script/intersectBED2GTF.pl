...
pod2usage ("I need an input .bed file (option --bed or -b)...\n") unless (-r $vcffile);
...
# Intersect command
my $command="intersectBed -a $bedfile -b $gtffile -wa -wb -loj |";
